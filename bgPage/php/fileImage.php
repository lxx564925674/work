<?php
    ...
    $name =date('YmdHis',time()).mt_rand(0,9999);
    $dir_base = "upload/fileImage/".$name;     //文件上传根目录
    //没有成功上传文件，报错并退出。
    $output = "<textarea>";
    ...
    foreach($_FILES as $file){
        ...
        if($isMoved){
            ...
            $output .= "<img src='php/{$dir_base}{$filename}' title='{$filename}' alt='{$filename}'/>";
        }else {
    ...
    $_POST = array();
    echo 'http://www.work.com/bgPage/php/'.$dir_base.$gb_filename;
